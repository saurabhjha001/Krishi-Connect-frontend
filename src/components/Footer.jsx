...
// with useful links, contact information, and social media links.
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-relaxed">
              Empowering farmers with digital tools to manage their products, track market prices, and access government schemes.
            </p>
          </div>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link to="/" className="text-xs sm:text-sm md:text-base text-gray-600 hover:text-blue-600 transition-colors inline-block">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/products" className="text-xs sm:text-sm md:text-base text-gray-600 hover:text-blue-600 transition-colors inline-block">
                  Products
                </Link>
              </li>
              <li>
                <Link to="/add" className="text-xs sm:text-sm md:text-base text-gray-600 hover:text-blue-600 transition-colors inline-block">
                  Add Product
                </Link>
              </li>
            </ul>
